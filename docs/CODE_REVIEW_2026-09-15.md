...
**Improvement status:** I01 done in main@7a90a76 (ADR-0035); I02 in main@6928708; I03 in main@e7cb1da; I04 in main@a9d2d73; I05 in main@9945456; I07 in main@762c432 (ADR-0033); I09 in main@a8041a3; I06 in main@5f1d9db and main@a4243f3; I10 in PROGRESS (separate "Open validation or data" column) and main@de8114f; I08 in main@cbd40b6 (three new bugs pinned as disabled tests; the reminder one fixed in main@37ac1b2, the two search ones in main@6be22a5).
...
**Feature status:** F01 done in main@60cca26 (ADR-0034); F02 in main@f31a07c; F07 in main@381f6c0, main@d15b2a4 and main@3170881; F03 in main@9a3ff36 (Room schema 7).
