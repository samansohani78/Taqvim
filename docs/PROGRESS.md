...
| T-104 | Islamic Iran official (A-05) + observational (A-06) | WIP | main@28a2d16 | G: IranIslamicCalendarTest — every lunar date of the official 1404/1405 calendars (730), 26 published month starts and lengths, table edges, 29/30-day months and continuity 1440–1455, 100 000 random round-trips, invalid input · U: HijriDateResolverTest — precedence official > offset > estimate, 30-day expiry with FakeClock, future-dated offset, ±2 bound | A-05 done: IslamicMonthTable + IranOfficialMonthStarts (Ramadan 1446 – Shawwal 1448), tabular estimate aligned at both edges, HijriDateSource explanation (ADR-0009). Remaining: A-06 Yallop estimate after T-400/T-403; more official years via D-07 (DT-002) |
