...
| DT-019 | Persian (`fa`) titles of the UN international days | All of D-05 (`fa` is mandatory in the schema) | UN Information Centre Tehran, "مناسبت های ویژه سازمان ملل متحد", https://www.unic-ir.org/event/f-event.htm — HTTP 522 from the development network and 403 to the fetch tool (2026-09-13); un.org has no Persian list | Waiting for owner decision |
